...
?> 
        ...
        <main class="a_page" id="gb_page">
            ...
            <p>
                ...
                practically no repetition. Nearly nothing repeats, besides the background of course. Moving to 
                alignment, we can clearly see that the webpage does not even use half of its width, left-aligned with much of its 
